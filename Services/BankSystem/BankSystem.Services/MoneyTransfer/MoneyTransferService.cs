...
namespace BankSystem.Services.MoneyTransfer
{
    public class MoneyTransferService : BaseService, IMoneyTransferService
    {
        ...
        public async Task<IEnumerable<T>> GetMoneyTransfersAsync<T>(string userId, int pageIndex = 1,
        ...
        public async Task<IEnumerable<T>> GetMoneyTransfersForAccountAsync<T>(string accountId, int pageIndex = 1,
            int count = int.MaxValue)
            where T : MoneyTransferBaseServiceModel
        {
            return await Context
            ...
            where T : MoneyTransferBaseServiceModel
        {
            ...
            BankSystem.Models.MoneyTransfer dbModel = mapper.Map<BankSystem.Models.MoneyTransfer>(model);
            BankSystem.Models.BankAccount userAccount = await Context
                .Accounts
                .Include(u => u.User)
