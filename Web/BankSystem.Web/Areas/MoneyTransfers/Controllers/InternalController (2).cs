...
namespace BankSystem.Web.Areas.MoneyTransfers.Controllers
{
    ...
    public class InternalController : BaseMoneyTransferController
    {
        ...
        public async Task<IActionResult> Create(InternalMoneyTransferCreateBindingModel model)
        {
            ...
            BankAccountDetailsServiceModel account = await bankAccountService.GetByIdAsync<BankAccountDetailsServiceModel>(model.AccountId);
            ...
            MoneyTransferCreateServiceModel destinationServiceModel = Mapper.Map<MoneyTransferCreateServiceModel>(model);
