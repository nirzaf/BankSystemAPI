namespace BankSystem.Web.Infrastructure.Extensions
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        private static async Task InitializeDatabaseAsync(IApplicationBuilder app)
        {
            ...
            BankSystemDbContext dbContext = serviceScope.ServiceProvider.GetRequiredService<BankSystemDbContext>();
            UserManager<BankUser> userManager = serviceScope.ServiceProvider.GetService<UserManager<BankUser>>();
