namespace BankSystem.Services.Tests.Tests
{
    ...
    public abstract class BaseTest
    {
        ...
        protected BankSystemDbContext DatabaseInstance
        {
            get
            {
                DbContextOptions<BankSystemDbContext> options = new DbContextOptionsBuilder<BankSystemDbContext>()
        ...
        protected Mock<IOptions<BankConfiguration>> MockedBankConfiguration
        {
            get
            {
                ...
                Mock<IOptions<BankConfiguration>> options = new Mock<IOptions<BankConfiguration>>();
