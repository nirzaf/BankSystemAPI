namespace BankSystem.Services.Tests.Tests
{
    ...
    public class BankAccountServiceTests : BaseTest
    {
        ...
        {
            // Arrange
            BankAccount model = await SeedBankAccountAsync();
            var newName = "changed!";
            ...
            BankAccount dbModel = await dbContext
                .Accounts
                .FindAsync(model.Id);
        ...
        public async Task CreateAsync_WithInvalidUserId_Should_ReturnNull_And_NotInsertInDatabase()
        {
            // Arrange
            await SeedUserAsync();
            BankAccountCreateServiceModel model = new BankAccountCreateServiceModel { Name = SampleBankAccountName, UserId = null };
        ...
        public async Task CreateAsync_WithValidModel_AndEmptyName_Should_SetRandomString()
        {
            ...
            await SeedUserAsync();
            BankAccountCreateServiceModel model = new BankAccountCreateServiceModel { UserId = SampleBankAccountUserId };
        ...
        public async Task GetAccountsAsync_Should_ReturnCollectionWithCorrectModels()
        {
            ...
            // Act
            IEnumerable<BankAccountDetailsServiceModel> result = await bankAccountService.GetAccountsAsync<BankAccountDetailsServiceModel>();
        ...
        public async Task GetByIdAsync_WithInvalidBankAccountId_Should_ReturnNull()
        {
            ...
            // Act
            BankAccountConciseServiceModel result = await bankAccountService.GetByIdAsync<BankAccountConciseServiceModel>(null);
        ...
        public async Task GetByIdAsync_WithValidBankAccountId_Should_ReturnCorrectEntity()
        {
            ...
            // Act
            BankAccountIndexServiceModel result = await bankAccountService.GetByIdAsync<BankAccountIndexServiceModel>(model.Id);
        ...
        public async Task GetByUniqueIdAsync_WithInvalidUniqueId_Should_ReturnNull()
        {
            ...
            // Act
            BankAccountIndexServiceModel result = await bankAccountService.GetByUniqueIdAsync<BankAccountIndexServiceModel>(null);
        ...
        public async Task GetByUniqueIdAsync_WithValidUniqueId_Should_ReturnCorrectEntity()
        {
            ...
            // Act
            BankAccountIndexServiceModel result = await bankAccountService.GetByUniqueIdAsync<BankAccountIndexServiceModel>(model.UniqueId);
