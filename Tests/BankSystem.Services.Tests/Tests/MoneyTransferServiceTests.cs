...
namespace BankSystem.Services.Tests.Tests
{
    public class MoneyTransferServiceTests : BaseTest
    {
        ...
        public async Task GetMoneyTransferAsync_WithValidNumber_Should_ReturnCorrectEntities()
        {
            ...
            await dbContext.Transfers.AddAsync(new BankSystem.Models.MoneyTransfer
            {
        ...
        public async Task CreateMoneyTransferAsync_WithInvalidDestinationBankAccountUniqueId_Should_ReturnFalse()
        {
            ...
            MoneyTransferCreateServiceModel model =
                PrepareCreateModel(destinationBankUniqueId: invalidDestinationBankAccountUniqueId);
        ...
        {
            // Arrange
            BankSystem.Models.MoneyTransfer model = await SeedMoneyTransfersAsync();
            // Act
            IEnumerable<MoneyTransferListingServiceModel> result =
        ...
        private async Task<BankSystem.Models.MoneyTransfer> SeedMoneyTransfersAsync()
        {
            await SeedBankAccountAsync();
            BankSystem.Models.MoneyTransfer model = new BankSystem.Models.MoneyTransfer
            {
                Id = SampleId,
                Description = SampleDescription,
                Amount = SampleAmount,
