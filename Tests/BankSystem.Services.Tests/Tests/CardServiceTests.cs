...
namespace BankSystem.Services.Tests.Tests
{
    public class CardServiceTests : BaseTest
    {
        ...
        public async Task GetAllCardsAsync_WithInvalidUserId_Should_ReturnEmptyCollection(string userId)
        {
            ...
            // Act
            IEnumerable<CardDetailsServiceModel> result =
                await cardService.GetCardsAsync<CardDetailsServiceModel>(userId);
        ...
        {
            // Arrange
            BankSystem.Models.Card model = await SeedCardAsync();
        ...
        public async Task GetAllCardsAsync_WithValidUserId_Should_ReturnCorrectCount()
        {
            ...
            // Act
            IEnumerable<CardDetailsServiceModel> result =
                await cardService.GetCardsAsync<CardDetailsServiceModel>(model.UserId);
        ...
        public async Task GetAsync_WithInvalidParameters_Should_ReturnNull()
        {
            ...
            // Act
            CardDetailsServiceModel result = await cardService.GetAsync<CardDetailsServiceModel>("wrong number",
                model.ExpiryDate,
        ...
        public async Task GetAsync_WithValidParameters_Should_ReturnCorrectEntity()
        {
            ...
            // Act
            CardDetailsServiceModel result = await cardService.GetAsync<CardDetailsServiceModel>(model.Number,
                model.ExpiryDate,
                model.SecurityCode, model.User.FullName);
        ...
        private async Task<BankSystem.Models.Card> SeedCardAsync()
        {
            await SeedUserAsync();
            BankSystem.Models.Card model = new BankSystem.Models.Card
            {
                Id = SampleCardId,
                Name = SampleName,
                Account = new BankSystem.Models.BankAccount(),
                ExpiryDate = SampleExpiryDate,
                Number = SampleNumber,
