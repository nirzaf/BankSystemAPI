namespace BankSystem.Services.Tests.Tests
{
    ...
    public class BankAccountUniqueIdHelperTests : BaseTest
    {
        ...
        public BankAccountUniqueIdHelperTests()
            => bankAccountUniqueIdHelper = new BankAccountUniqueIdHelper(MockedBankConfiguration.Object);

        [Fact]
        public void GenerateAccountUniqueId_Should_Return12DigitsString()
        {
            // Act
            var result = bankAccountUniqueIdHelper.GenerateAccountUniqueId();
        ...
        {
            // Act
            var result = bankAccountUniqueIdHelper.IsUniqueIdValid(id);
